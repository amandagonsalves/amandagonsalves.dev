    ...
    <div class="p-2 md:p-8 max-w-4xl mx-auto">
      <div class="px-4 font-poppins py-12">
        ...
        <p>
          ...
          <a :href="link" target="_blank" class="text-blue-500">here</a> and also <a class="text-blue-500" href="https://github.com/syscoin/pali_wallet" target="_blank">check Pali code on GitHub</a>.<br /><br />

          Pali also was announced on a Brazilian crypto news outlet. <a class="text-brand-darkpink" href="https://cointimes.com.br/empresa-brasileira-lanca-primeira-carteira-web3-para-bitcoin/">Check it out</a>.
        </p>
